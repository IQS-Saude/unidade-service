...
export class AtualizarUnidadeEnderecoRequest {
  @ApiProperty({
...
export class AtualizarUnidadeRequest {
  @ApiProperty({
    description: 'Id da unidade',
    example: 1,
  })
  @IsInt({ message: 'id deve ser um numero inteiro' })
  id: number;
  ...
  @ApiProperty({
    type: AtualizarUnidadeEnderecoRequest,
    description: 'Endereco da unidade',
  })
  @ValidateNested()
  @Type(() => AtualizarUnidadeEnderecoRequest)
  endereco: AtualizarUnidadeEnderecoRequest;
...
export class AtualizarUnidadeDataRequest {
  @ApiProperty()
